...
@section('content')
    ...
    <form method="POST" action="{{route('guides.update', $guide->slug)}}">
    {{method_field('PATCH')}}
    @csrf
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input id="publish_date" type="text" class="form-control" name="publish_date" value="{{ old('publish_date', $guide->publish_date) }}">
